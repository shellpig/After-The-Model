...
- `開發設計方針.md` — 實作細節、檔案結構、Autoload 簽名、資料契約
- `測試指南.md` — Godot 測試流程、手動驗收清單
...
**規劃中：**
- `遊戲規格書.md` — 由 `遊戲概念.md` + `技術概念.md` 衍生，定義場景、NPC、任務、系統的具體規格
- `開發設計方針.md` — 實作指引（檔案清單、Autoload 簽名、資料契約）
- `測試指南.md` — 測試流程與驗收標準
- `驗證後已知問題.md` — 驗收問題追蹤
