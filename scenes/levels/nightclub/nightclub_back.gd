# res://scenes/levels/nightclub/nightclub_back.gd
extends Node2D
...
var _entry_point_id: String = "from_lobby"
var _entry_payload: Dictionary = {}

func prepare_entry_point(entry_point_id: String, payload: Dictionary = {}) -> void:
	_entry_point_id = entry_point_id if not entry_point_id.is_empty() else "from_lobby"
...
func _ready() -> void:
	...
	if main and main.has_method("play_bgm"):
		main.play_bgm("res://assets/bgm/nightclub-2.mp3")
...
func _trigger_interaction() -> void:
	match current_interactable.interaction_id:
		"exit_to_lobby":
			scene_transition_requested.emit("nightclub", "from_back", {})
