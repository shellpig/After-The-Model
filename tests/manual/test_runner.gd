...
func _ready() -> void:
	...
	if store_player.global_position.distance_to(store_spawn.global_position) > 1.0:
	...
	if street_back_player.global_position.distance_to(street_back_spawn.global_position) > 1.0:
